...
+14644009780----http://a.62-us.com/api/get_sms?key=08722664d1449c4839e5073bc03dccb0
```
...
第一版正式支持两种分隔格式：`|` 和 `----`。导入后统一写入 `paypal_phone_pool(phone, sms_url)`。
